...
dataSet = 'IndianPines'
test = 'eapInception'            # test folder
fe_eap = True            # false for PCA, true for EAP 
vectNets =[9, 9, 5, 4]   # [FE, LRC, RIE, SVM]   
...
logger_LRC = DataLogger(fileName = dataSet+'_LRC', folder = test, save = False)   
logger_RIE = DataLogger(fileName = dataSet+'_RIE', folder = test, save = False) 
logger_SVM = DataLogger(fileName = dataSet+'_SVM', folder = test, save = False) 
