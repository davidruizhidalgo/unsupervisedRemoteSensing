%RBF => LOAD TRAINING DATA
clear, clc, close all;
porData=0.5;    %PERCENTAGE OF TRAINING DATA
...
%TAKING FROM GROUND TRUTH ALL CLASS ELEMENTS    
    ...
    class0=zeros(1,3);class1=zeros(1,3);class2=zeros(1,3);class3=zeros(1,3);
    class4=zeros(1,3);class5=zeros(1,3);class6=zeros(1,3);class7=zeros(1,3); 
    class8=zeros(1,3);class9=zeros(1,3);class10=zeros(1,3);class11=zeros(1,3); 
    class12=zeros(1,3);class13=zeros(1,3);class14=zeros(1,3);class15=zeros(1,3); 
    class16=zeros(1,3); 
...
for i=1:size(dataClass0,2)
    k=dataToTrain(j);
    pxData=dataCube(class0(k,1),class0(k,2),:);
    dataClass0(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass1,2)
    k=dataToTrain(j);
    pxData=dataCube(class1(k,1),class1(k,2),:);
    dataClass1(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass2,2)
    k=dataToTrain(j);
    pxData=dataCube(class2(k,1),class2(k,2),:);
    dataClass2(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass3,2)
    k=dataToTrain(j);
    pxData=dataCube(class3(k,1),class3(k,2),:);
    dataClass3(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass4,2)
    k=dataToTrain(j);
    pxData=dataCube(class4(k,1),class4(k,2),:);
    dataClass4(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass5,2)
    k=dataToTrain(j);
    pxData=dataCube(class5(k,1),class5(k,2),:);
    dataClass5(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass6,2)
    k=dataToTrain(j);
    pxData=dataCube(class6(k,1),class6(k,2),:);
    dataClass6(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass7,2)
    k=dataToTrain(j);
    pxData=dataCube(class7(k,1),class7(k,2),:);
    dataClass7(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass8,2)
    k=dataToTrain(j);
    pxData=dataCube(class8(k,1),class8(k,2),:);
    dataClass8(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass9,2)
    k=dataToTrain(j);
    pxData=dataCube(class9(k,1),class9(k,2),:);
    dataClass9(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass10,2)
    k=dataToTrain(j);
    pxData=dataCube(class10(k,1),class10(k,2),:);
...
for i=1:size(dataClass11,2)
    k=dataToTrain(j);
    pxData=dataCube(class11(k,1),class11(k,2),:);
...
for i=1:size(dataClass12,2)
    k=dataToTrain(j);
    pxData=dataCube(class12(k,1),class12(k,2),:);
...
for i=1:size(dataClass13,2)
    k=dataToTrain(j);
    pxData=dataCube(class13(k,1),class13(k,2),:);
...
for i=1:size(dataClass14,2)
    k=dataToTrain(j);
    pxData=dataCube(class14(k,1),class14(k,2),:);
...
for i=1:size(dataClass15,2)
    k=dataToTrain(j);
    pxData=dataCube(class15(k,1),class15(k,2),:);
...
for i=1:size(dataClass16,2)
    k=dataToTrain(j);
    pxData=dataCube(class16(k,1),class16(k,2),:);
    dataClass16(:,i)= pxData(:);
    j=j+1;  
end

save('trainingDataRBF','dataClass0','dataClass1','dataClass2',...
    'dataClass3','dataClass4','dataClass5','dataClass6','dataClass7',...
    'dataClass8','dataClass9','dataClass10','dataClass11','dataClass12',...
    'dataClass13','dataClass14','dataClass15','dataClass16');
