...
for i=1:size(dataClass0,2)
    k=dataToTrain(j);
    pxData=dataSOM(class0(k,1),class0(k,2),:);
    dataClass0(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass1,2)
    k=dataToTrain(j);
    pxData=dataSOM(class1(k,1),class1(k,2),:);
    dataClass1(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass2,2)
    k=dataToTrain(j);
    pxData=dataSOM(class2(k,1),class2(k,2),:);
    dataClass2(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass3,2)
    k=dataToTrain(j);
    pxData=dataSOM(class3(k,1),class3(k,2),:);
    dataClass3(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass4,2)
    k=dataToTrain(j);
    pxData=dataSOM(class4(k,1),class4(k,2),:);
    dataClass4(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass5,2)
    k=dataToTrain(j);
    pxData=dataSOM(class5(k,1),class5(k,2),:);
    dataClass5(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass6,2)
    k=dataToTrain(j);
    pxData=dataSOM(class6(k,1),class6(k,2),:);
    dataClass6(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass7,2)
    k=dataToTrain(j);
    pxData=dataSOM(class7(k,1),class7(k,2),:);
    dataClass7(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass8,2)
    k=dataToTrain(j);
    pxData=dataSOM(class8(k,1),class8(k,2),:);
    dataClass8(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass9,2)
    k=dataToTrain(j);
    pxData=dataSOM(class9(k,1),class9(k,2),:);
    dataClass9(:,i)= pxData(:);
    j=j+1;  
end
...
for i=1:size(dataClass10,2)
    k=dataToTrain(j);
    pxData=dataSOM(class10(k,1),class10(k,2),:);
...
for i=1:size(dataClass11,2)
    k=dataToTrain(j);
    pxData=dataSOM(class11(k,1),class11(k,2),:);
...
for i=1:size(dataClass12,2)
    k=dataToTrain(j);
    pxData=dataSOM(class12(k,1),class12(k,2),:);
...
for i=1:size(dataClass13,2)
    k=dataToTrain(j);
    pxData=dataSOM(class13(k,1),class13(k,2),:);
...
for i=1:size(dataClass14,2)
    k=dataToTrain(j);
    pxData=dataSOM(class14(k,1),class14(k,2),:);
...
for i=1:size(dataClass15,2)
    k=dataToTrain(j);
    pxData=dataSOM(class15(k,1),class15(k,2),:);
...
for i=1:size(dataClass16,2)
    k=dataToTrain(j);
    pxData=dataSOM(class16(k,1),class16(k,2),:);
    dataClass16(:,i)= pxData(:);
    j=j+1;  
end

save('datosEntrenamientoSOM','dataClass0','dataClass1','dataClass2',...
